...
func testbtcsign() {
	...
	sign, err := wallet.SendBTCRawTxByPrivateKey(btc0, btc1address, 0.001, 0.00004, "testmemobraddddddddddddddddddddddddtestmemobraddddddddddddddddddddddddddddddddddf")
	if err != nil {
		fmt.Println(err)
		return
	}
